...
/* Definitions for sub_task */
osThreadId_t sub_taskHandle;
const osThreadAttr_t sub_task_attributes = {
  .name = "sub_task",
  .stack_size = 256 * 4,
...
extern void subTask(void *argument);
extern void mainTask(void *argument);
extern void Callback01(void *argument);
